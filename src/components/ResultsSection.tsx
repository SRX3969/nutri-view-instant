...
export function ResultsSection({
  ...
  return <div className="w-full max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      {/* Calories Card */}
      <Card className="glass border-primary/20 p-8 text-center animate-scale-in hover-lift" style={{
      animationDelay: "0.1s"
    }}>
        ...
        <div style={{
        animationDelay: "0.2s"
      }} className="text-7xl font-bold gradient-nature bg-clip-text text-transparent mb-3 animate-scale-in bg-slate-50">
          {data.calories}
        </div>
      ...
      {/* Pie Chart */}
      <Card className="glass border-primary/20 p-8 animate-scale-in hover-lift" style={{
      animationDelay: "0.2s"
    }}>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        animationDelay: `${0.3 + index * 0.1}s`
            ...
            <Progress value={macro.value / macro.max * 100} className="h-3 transition-all duration-1000 ease-out" />
      ...
      {/* Tips */}
      {data.tips.length > 0 && <Card className="glass border-primary/20 p-8 animate-scale-in hover-lift" style={{
      animationDelay: "0.6s"
    }}>
          ...
          return <li key={index} className="text-base text-foreground flex items-start gap-3 p-3 rounded-lg hover:bg-primary/5 transition-smooth">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
        {!isSaved && <Button onClick={handleSave} size="lg" className="gradient-nature hover:opacity-90 hover:scale-105 transition-smooth text-white font-bold px-10 py-7 text-lg rounded-xl animate-scale-in shadow-lg" style={{
        animationDelay: "0.7s"
      }}>
            <Save className="mr-2 h-6 w-6" />
            Save to History
          </Button>}
        <Button onClick={onAnalyzeAnother} size="lg" className="gradient-gold hover:opacity-90 hover:scale-105 transition-smooth text-white font-bold px-10 py-7 text-lg rounded-xl animate-scale-in shadow-lg pulse-glow" style={{
        animationDelay: "0.8s"
      }}>
